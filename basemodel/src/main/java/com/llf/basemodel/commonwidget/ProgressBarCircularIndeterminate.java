...
public class ProgressBarCircularIndeterminate extends RelativeLayout {
    ...
    final int disabledBackgroundColor = ContextCompat.getColor(this.getContext(),R.color.DeepSkyBlue);
    int beforeBackground;
    float radius1 = 0;
    float radius2 = 0;
    int cont = 0;
    boolean firstAnimationOver = false;
    int backgroundColor = ContextCompat.getColor(this.getContext(),R.color.DeepSkyBlue);
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        if (bacgroundColor != -1) {
            ...
            if (background != -1)
                ...
                setBackgroundColor(ContextCompat.getColor(this.getContext(),R.color.DeepSkyBlue));
        }
